                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        @endcan @can('view', $prize)
                                        <a
                                            href="{{ route('prizes.show', $prize) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $prize)
                                        <form
                                            action="{{ route('prizes.destroy', $prize) }}"
                                            method="POST"
